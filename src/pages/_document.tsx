  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:title" content="Ken Tauchi | Software Engineer" />
        <meta
          property="og:description"
          content="Experienced Software Engineer specializing in fontend development, and building scalable applications."
        />
        ...
        <meta name="twitter:title" content="Ken Tauchi | Software Engineer" />
        <meta
